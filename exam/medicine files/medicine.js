async function loadProducts() {
    const productsContainer = document.querySelector('.medicine');
    ...
    try {
        ...
        data.forEach(product => {
            ...
            productElement.innerHTML = `
                <img src="${product.image}" alt="${product.name}" onclick="window.location.href='../info files/info3.html?id=${product.id}'">
                <h4>${product.name}</h4>
                <p>$${product.price}</p>
